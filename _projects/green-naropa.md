...
<div class="row">
  <div class="col s6 m4 l3">
    <img class="materialboxed"
      ...
      to biking more"
      alt="Inspiring Small Actions: From re-using one's water bottle
      to biking more"
...
<div class="row">
  <div class="col s6 m4 l3">
    <img class="materialboxed"
      ...
      alt="Did you know that each 12 ounce plastic water bottle causes
      0.15 pounds of CO2 emissions?"
      src="{{ page.url | prepend: '/images' | prepend: site.baseurl | append: 'screenshot_5.png' }}"/>
  </div>
  ...
  <div class="col s6 m4 l3">
    <img class="materialboxed"
      ...
      a new book!"
      alt="Boulder has plenty of resources, so that you never have to buy
      a new book!"
...
<img class="materialboxed"
  ...
  alt="Total of 403 page views, 192 visitors, and an average visit
  duration of two minutes"
